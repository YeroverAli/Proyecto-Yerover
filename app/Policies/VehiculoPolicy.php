...
class VehiculoPolicy
{
    ...
    {
        return $user->hasPermissionTo('ver vehiculos');
    }
    ...
    {
        return $user->hasPermissionTo('crear vehiculos');
    }
    ...
    {
        return $user->hasPermissionTo('editar vehiculos');
    }
    ...
    {
        return $user->hasPermissionTo('eliminar vehiculos');
    }
