                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($vehiculo->color_externo)
                                                    <span class="badge"
                                                        style="background-color: {{ strtolower($vehiculo->color_externo) }}; color: white;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($vehiculo->color_interno)
                                                    <span class="badge"
                                                        style="background-color: {{ strtolower($vehiculo->color_interno) }}; color: white;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <small class="text-muted">a las
                                                    {{ $vehiculo->created_at->format('H:i') }}</small>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <small class="text-muted">a las
                                                    {{ $vehiculo->updated_at->format('H:i') }}</small>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
