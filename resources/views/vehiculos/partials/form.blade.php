...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        <input id="version" type="text" class="form-control @error('version') is-invalid @enderror" name="version"
            value="{{ old('version', $vehiculo->version ?? '') }}" required>
        @error('version')
            <span class="invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        <input id="bastidor" type="text" class="form-control @error('bastidor') is-invalid @enderror" name="bastidor"
            value="{{ old('bastidor', $vehiculo->bastidor ?? '') }}">
        @error('bastidor')
            <span class="invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        <input id="referencia" type="text" class="form-control @error('referencia') is-invalid @enderror"
...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        <input id="color_externo" type="text" class="form-control @error('color_externo') is-invalid @enderror"
...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        <input id="color_interno" type="text" class="form-control @error('color_interno') is-invalid @enderror"
...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        <select id="empresa_id" class="form-select @error('empresa_id') is-invalid @enderror" name="empresa_id"
            required>
